...
return array(
	...
	'wf_dhl_ecommerce' => array(
		'name'  => 'DHL ecommerce',
		'tracking_url' => 'http://www.dhl.com/en/ecommerce/tracking.html?AWB=',
		'api_url' => ''
	),
	'wf_dhl_usa' => array(
		'name'  => 'DHL USA',
		'tracking_url' => 'http://www.dhl-usa.com/content/us/en/ecommerce/tracking.shtml?brand=DHL&AWB=',
		'api_url' => ''
	),
	'wf_dhl_global' => array(
		'name'  => 'DHL Global',
	...
	'wf_estes_ecommerce' => array(
		'name'  => 'ESTES ecommerce',
		'tracking_url' => 'http://http://www.estes-ecommerce.com/cgi-dta/edn419.mbr/output?search_criteria=',
		'api_url' => ''
	),
	...
	'wf_skynet_ww_ex' => array(
		'name'  => 'SkyNet Worldwide ecommerce',
	...
	'wf_averitt_ecommerce' => array(
		'name'  => 'Averitt ecommerce',
		'tracking_url' => 'https://www.averittecommerce.com/trackLTLById.avrt?serviceType=LTL&resultsPageTitle=LTL+Tracking+by+PRO+and+BOL&trackPro=',
		'api_url' => ''
	),
	'wf_adrexo' => array(
	...
	'wf_interlink_ecommerce_1' => array(
		'name'  => 'Interlink ecommerce (1)',
		'tracking_url' => 'http://www.interlinkecommerce.com/apps/tracking/?reference=',
		'api_url' => ''
	),
	'wf_interlink_ecommerce_2' => array(
		'name'  => 'Interlink ecommerce (2)',
		'tracking_url' => 'http://www.interlinkecommerce.com/apps/tracking/?help_type=%2Fapps%2Ftracking%2F%23results&reference=[ID]&postcode=[PIN]',
		'api_url' => ''
	),
	'wf_uk_mail' => array(
		'name'  => 'UK Mail',
	...
	'wf_dhl_cz' => array(
		'name'  => 'DHL (CZ)',
		'tracking_url' => 'http://www.dhl.cz/cs/ecommerce/sledovani_zasilek.html?AWB=',
		'api_url' => ''
	),
	'wf_posta_cz' => array(
		'name'  => 'Posta (CZ)',
	...
	'wf_ctt_ecommerceo' => array(
		'name'  => 'CTT ecommerceo',
		'tracking_url' => 'http://www.cttecommerceo.pt/feapl_2/app/open/objectSearch/cttecommerceo_feapl_132col-cttecommerceoObjectSearch.jspx?lang=01&pesqObjecto.objectoId=',
		'api_url' => ''
	),
	'wf_giaohangnhanh' => array(
		'name'  => 'Giaohangnhanh',
		'tracking_url' => 'https://ontime.ghn.vn/Tracking/ViewTracking/[PIN]',
		'api_url' => ''
	),
	'wf_asm_es' => array(
		'name'  => 'ASM (ES)',
		'tracking_url' => 'http://www.asmred.com/extranet/public/ExpedicionASM.aspx?codigo=[ID]&cpDst=[PIN]',
		'api_url' => ''
	),
	'wf_tourline_ecommerce_es' => array(
		'name'  => 'Tourline ecommerce (ES)',
		'tracking_url' => 'http://www.tourlineecommerce.com/AreaClientes/Views/Destinatarios.aspx?s=[ID]&i=ES',
		'api_url' => ''
	),
	'wf_correos_ecommerce' => array(
		'name'  => 'Correos ecommerce',
		'tracking_url' => 'https://www.chronoexpres.com/chronoExtraNET/env/verEnvio.seam?s=[ID]',
		'api_url' => ''
	),
	'wf_mrw_es' => array(
		'name'  => 'MRW (ES)',
		'tracking_url' => 'http://www.mrw.es/seguimiento_envios/MRW_resultados_consultas.asp?modo=nacional&envio=[ID]',
		'api_url' => ''
	),
	'wf_la_poste' => array(
		'name'  => 'La Poste',
		'tracking_url' => 'http://www.csuivi.courrier.laposte.fr/suivi/index?id=[ID]',
		'api_url' => ''
	),
	// 'wf_' => array(
		// 'name'  => '',
