...
class WF_Boxpack_Express {
	...
	public function add_item( $length, $width, $height, $weight, $value = '', $meta = array()) {
		$this->items[] = new WF_Boxpack_Express_Item($length, $width, $height, $weight, $value, $meta);
	}
	...
	public function add_box( $length, $width, $height, $weight = 0, $packtype = '') {
		$new_box       = new WF_Boxpack_Express_Box($length, $width, $height, $packtype, $weight);
		$this->boxes[] = $new_box;
		return $new_box;
	}
...
/**
 * WF_Boxpack_Express_Box class.
 */
class WF_Boxpack_Express_Box {
...
/**
 * WF_Boxpack_Express_Item class.
 */
class WF_Boxpack_Express_Item {
