...
class wf_dhl_paket_woocommerce_shipping_method extends WC_Shipping_Method {
	...
	public function init_form_fields() {
		...
		//Paket Auto Label Generate Add-on.
		if (ELEX_DHL_PAKET_AUTO_LABEL_GENERATE_ADDON_WOOCOMMERCE_EXTENSION) {
			$auto_add_on_fields = include ELEX_DHL_PAKET_AUTO_LABEL_GENERATE_ADDON_WOOCOMMERCE_EXTENSION_PATH . 'includes/data-wf-settings.php' ;
