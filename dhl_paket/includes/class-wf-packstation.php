...
if (!class_exists('wf_packstation')) {
	class wf_packstation {
		...
		private function init() {
			...
			$this->site_id       = 	$this->production?'WooForceDHLPaket_v2_1':( isset($this->settings[ 'site_id' ]) ? $this->settings[ 'site_id' ] : '' );	// Site ID and Pass static for live mode 
